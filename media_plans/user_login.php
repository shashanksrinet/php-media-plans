...
$query = "SELECT email,username, password FROM users WHERE email='$username' AND password='$password'";
...
<html lang="en">
	...
	<head>
		...
		<link href="../assets/app/custom/login/login-v2.default.css" rel="stylesheet" type="text/css" />
					...
					<div class="kt-grid__item kt-grid__item--fluid kt-login__wrapper">
						<div class="kt-login__container">
							<div class="kt-login__logo">
								<a href="#">
									<img src="../assets/media/logos/logo-light-black.png">
								</a>
							</div>
							<div class="kt-login__signin">
								<div class="kt-login__head">
									<h3 class="kt-login__title">Sign In To Panel</h3>
								</div>
								<form name="loginForm" method="post" class="kt-form" action="" novalidate="novalidate">
									...
									<div class="kt-login__actions">
										<input type="submit" name="submit" id="" class="btn btn-pill kt-login__btn-primary">
									</div>
								</form>
							</div>
							...
							<div class="kt-login__account">
								<span class="kt-login__account-msg">
									Don't have an account yet ? Mail us at <a href="mailto:support@adomantra.com?Subject=Create%20Ola%20login" target="_top">support@adomantra.com</a>
								</span>&nbsp;&nbsp;
