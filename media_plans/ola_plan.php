...
//If User is Inactive For 15 mins
...
if(auto_logout("user_time"))
    {
        session_unset();
        session_destroy();
        header("Location: user_login.php?action=expired");          
        exit;
    } 
?>
<!DOCTYPE html>
			...
			-->
					...
					<div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
						<div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
							<ul class="kt-menu__nav ">
								<li class="kt-menu__item " aria-haspopup="true"><a href="ola_plan.php" class="kt-menu__link "><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
											...
											</svg></span><span class="kt-menu__link-text">Ola Plan</span></a></li>
				...
				<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
							...
							<div class="kt-header__topbar-item kt-header__topbar-item--user">
								<div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="0px,0px">
									<div class="kt-header__topbar-user">
										...
										<span class="kt-header__topbar-username kt-hidden-mobile"><?php echo $_SESSION['userName'];?></span>
										<img class="kt-hidden" alt="Pic" src="../assets/media/users/300_25.jpg" />

										<!--use below badge element instead the user avatar to display username's first letter(remove kt-hidden class to display it) -->
										<span class="kt-badge kt-badge--username kt-badge--unified-success kt-badge--lg kt-badge--rounded kt-badge--bold"><?php echo $_SESSION['userName'][0];?></span>
									</div>
								</div>
					...
					<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
						...
						<div class="kt-subheader   kt-grid__item" id="kt_subheader">
							...
							<div class="kt-subheader__toolbar">
								<div class="kt-subheader__wrapper">
									<a href="#" class="btn kt-subheader__btn-daterange" id="kt_dashboard_daterangepicker" data-toggle="kt-tooltip" title="" data-placement="left">
						...
						<!-- end:: Subheader -->
						<div class="kt-portlet kt-portlet--mobile" id="displayResult" style="display: none;">
								<div class="kt-portlet__head kt-portlet__head--lg">
									<div class="kt-portlet__head-label">
										...
										<h3 class="kt-portlet__head-title">
											Adomantra Plans
											<small>create plans for clients</small>
										</h3>
...
<div class="kt-portlet__head-toolbar">
	<div class="kt-portlet__head-wrapper">
		...
		<button id="DownloadExcel" type="button" class="btn btn-default btn-icon-sm" aria-haspopup="true" aria-expanded="false">
		<i class="la la-download"></i> Export
								...
								<div class="kt-portlet__body kt-portlet__body--fit">
									...
									<!--begin: Datatable -->
									<div class="kt-datatable kt-datatable--default kt-datatable--brand kt-datatable--loaded"><table class="kt-datatable__table" id="html_table" width="100%" style="display: block; min-height: 300px;">
										<thead class="kt-datatable__head">
											
										<tr class="kt-datatable__row" style="left: 0px;"><th class="kt-datatable__cell kt-datatable__toggle-detail"><span></span></th><th data-field="Order ID" class="kt-datatable__cell kt-datatable__cell--sort"><span style="width: 113px;">Device</span></th><th data-field="Car Make" class="kt-datatable__cell kt-datatable__cell--sort"><span style="width: 113px;">AdType</span></th><th data-field="Car Model" class="kt-datatable__cell kt-datatable__cell--sort"><span style="width: 113px;">Budget</span></th><th data-field="Color" class="kt-datatable__cell kt-datatable__cell--sort"><span style="width: 113px;">Targetting</span></th><th data-field="Deposit Paid" class="kt-datatable__cell kt-datatable__cell--sort"><span style="width: 113px;">Total Impression</span></th><th data-field="Type" data-autohide-disabled="false" class="kt-datatable__cell kt-datatable__cell--sort"><span style="width: 113px;">CTR%</span></th></tr></thead>

<tbody id="FinalResults" class="kt-datatable__body" style="">
</tbody>
</table>
</div>
...
<!--begin::Form-->
<form class="kt-form" name="myformData" id="myformData">
	...
	<div class="form-group">
		...
		<?php
		$rowcount = '';
    	$querydevice = "SELECT id,`deviceType` FROM `device` ";
    	$querydevice = mysqli_query($con,$querydevice);
    	$rowcount=mysqli_num_rows($querydevice);
    	while ( $row=mysqli_fetch_assoc($querydevice)) {
    		echo "<label class='kt-checkbox'><input type='checkbox' id='deviceName".$row['id']."' name='".$row['deviceType']."' value='".$row['id']."'> ".$row['deviceType']."<span></span></label>";
    	}
    	/*while ( $row=mysqli_fetch_assoc($querydevice)) {
      		echo "<option value='".$row['id']."'>".$row['deviceType']."</option>";
    	}*/
    	?>
    </div>
	</div>
	...
	<div class="form-group">
	<label for="exampleSelect2" id="adtypelable" style="display: none;">Select Ad Type</label>
	<select multiple="" class="form-control" id="SelectAdtype" style="display: none;">
	<option>Select Ad Type</option>
	<?php
    	$querydevice = "SELECT `type`,`id`,`deviceId`,typeRate FROM `adtype`";
    	$querydevice = mysqli_query($con,$querydevice);
    	while ( $row=mysqli_fetch_assoc($querydevice)) {
	...
	<button onclick="inputBudget()" style="display: none;" id="addAdType" type="button" class="btn btn-primary">Add</button>
	<br>
	<div class="form-group row" id="inputBudget">
	
	</div>

<div id="additionalTargeting" class="form-group form-group-last" style="display: none;">
	<div class="form-group">
	<label>Additional Targetting</label>
	<div class="kt-checkbox-list">
	<?php
    	$querydevice = "SELECT type_target,`rate` FROM `additional_targeting` ";
    	$querydevice = mysqli_query($con,$querydevice);
    	while ( $row=mysqli_fetch_assoc($querydevice)) {
    		echo "<label class='kt-checkbox'><input type='checkbox' id='AdditionalTargetings' name='".$row['type_target'].'-TG'."' value='".$row['rate']."'> ".$row['type_target'].'&nbsp;&nbsp;'.$row['rate']."<span></span></label>";
    	}
    ?>
...
<script type="text/javascript">
	$("#selectDevice").change(function() {
    	...
    	$(this).data('options', $('#SelectAdtype option').clone());
  	}
  	var id = $(this).val();
  	...
  	$('#SelectAdtype').show();
  	$('#addAdType').show();
  	$('#additionalTargeting').show();
  	$('#SelectAdtype').html(options);
  	$("#inputBudget").empty();
  	$("#plateform").empty();
  	//$('#additionalTargeting').empty();
});
</script>
<script type="text/javascript">
	function inputBudget() {
		var d = $('#SelectAdtype option:selected').val();
		var ad_type = $('#SelectAdtype option:selected').text();
		var firstWord = ad_type.replace(/ .*/, '');
		//alert(firstWord);
		if (ad_type){
			$('#inputBudget').prepend('<label for="example-number-input" id="'+firstWord+'text" class="col-2 col-form-label">'+ad_type+'</label><div class="col-10"><input class="userBudgetinput form-control" type="text" name="'+ad_type+'" id="'+ firstWord +'" /></div></div>');
		$('#SelectAdtype option:selected').remove();
		}else{
...
<a href="#">
<button id="generateData" type="button" class="btn btn-primary">Submit</button>
</a>
...
<!-- CheckBox Device Result -->
<script type="text/javascript">
	$(document).ready(function() {
    	var TotalDevice = "<?php echo $rowcount;?>";
    	for (var i = 1; i <= TotalDevice; i++) {
    		$("#deviceName"+i).click(function() {
    		...
    		//alert(id + name);
    		/*var name = $("#deviceName"+i).val();  */           
		      $.ajax({    //create an ajax request to display.php
		        type: "POST",
		        url: "getAdType.php",             
		        data:{DeviceId:id,DeviceName:name,DevicecheckStatus:checkStatus},   //expect html to be returned                
		        success: function(response){
		        	//console.log(response);                    
		            $("#deviceResult").prepend(response); 
		            //alert(response);
		        }
...
<script type="text/javascript">
	$(document).ready(function() {
		$("#generateData").click(function() {
			var successCount = 0;
			$("#FinalResults").empty();
			var DeviceCount = "<?php echo $rowcount;?>";
    		for (var i = 1; i <= 10; i++) {
    		//$("#deviceName"+i).click(function() {
    		var Status = false;
    		var checked= true;
    		if(checked){
    			...
    			console.log('Count=='+i);
    			var targettingsValue = 0;
				var targettingsName = '';
				var budgetsID,budgetsValue,adtypeName;
			$('#Checkboxinfo'+i).find('[type=checkbox],input[type=text]').each(function () {
	    			
    				targettingsName = ''; 
				    targettingsValue = 0;
				    
	    			if($(this).is('input[type=text]')){
	    				$('#Checkboxinfo'+i +' input:checked').each(function() {
    						targettingsName  += '+TG+'+this.name;
    						targettingsValue += parseInt(this.value);
						});
	    				var DeviceNameid = $('#Checkboxinfo'+i).find('input[type=hidden]:first').val();

	    				budgetsID    = this.id;
	    				budgetsValue = this.value;
	    				adtypeName   = this.name;
	    				successCount++;
	    				$.ajax({    //create an ajax request to display.php
				        type: "POST",
				        url: "totalImpression.php",             
				        data:{DeviceNameId:DeviceNameid,Budgetid:budgetsID,Adtype_name:adtypeName,Budgets_value:budgetsValue,TGValue:targettingsValue,TGName:targettingsName,successCountData:successCount},   //expect html to be returned                
				        success: function(response){
				        	//console.log(response);
				        	if ($.trim(response)){
				        		$('#displayResult').show();
				        		//successCount++;
				        		//console.log('successResponse'+successCount);
				        	}
				        	targettingsName = ''; 
				        	targettingsValue = 0;
				        	$("#FinalResults").append(response);
				        	//console.log($("#downloadExcelUrl1").val());
				        }
...
<script type="text/javascript">
	$(document).ready(function() {
		$("#DownloadExcel").click(function() {
			var inputs = $("#FinalResults .downloadExcelUrl");
			console.log(inputs.length);
			var queryString = '';
			for(var i = 0; i < inputs.length; i++){
				queryString += $(inputs[i]).val()+'$';
    			//alert($(inputs[i]).val());
			}
			window.open("download.php?"+queryString,'_blank')
...
<script type="text/javascript">
	$("#calculateData").on('click', function() {
		var finalGeo = 0;
		$('input[id="AdditionalTargetings"]:checked').each(function() {
			finalGeo += parseInt($(this).val());
		});
  		$( "#TotalImp" ).empty();
  		$( "#TotalImp" ).remove();
  		$("input[type='hidden']").remove();
    	$("#inputBudget input").each(function() {
    		
    		var rate = $(this).attr('name');
    		var userBudget = $(this).val();
			var lastWord = rate.match(/\w+$/)[0];
			var totalRate = parseInt(lastWord)+parseInt(finalGeo);
			var formula = Math.round((userBudget*1000)/totalRate);
			$('<input>', {type: 'hidden',id: 'TotalImp',name: rate+'-imp',value: formula
    		}).appendTo('form');
    	});

    	

    	var para = $('#myformData').serialize();
    	var displayResult = $('#myformData').serializeArray();
    	//alert(para);
    	$( "#excelDownload" ).empty();
    	$( "#plateform" ).empty();
    	$( "#excelDownload" ).append( '<a  href="download.php?'+para+'" target="_blank">Excel Report</a>');

    	jQuery.each(displayResult, function( i, field ) {
    	if (field.name == 'selectDevice') {
    		if (field.value == 1) {
    			field.name = 'Device';
    			field.value = 'Ola App';
    		}else if(field.value == 2){
    			field.name = 'Device';
    			field.value = 'Ola Play';
    		}
    	}
    	$( "#plateform" ).append( '<div class="form-group row" id="plateform"><div class="col-6"><label class="col-form-label">'+field.name+'</label></div><div class="mt-2 col-6"><span class="form-control" id="plateform">'+field.value+'</span></div></div>');
    });
...
<script type="text/javascript">
	/*function onSubmit( form ){
  	...
  	//$('.kt-portlet__body').html(formData);
...
<!--end::Form-->
								...
								<div class="col-md-6" id="deviceResult"></div>
							</div>
						</div>
					...
					<div class="kt-footer kt-grid__item kt-grid kt-grid--desktop kt-grid--ver-desktop">
						<div class="kt-footer__copyright">
							2019&nbsp;&copy;&nbsp;<a href="https://adomantra.com/" target="_blank" class="kt-link">Adomantra</a>
						</div>
						<div class="kt-footer__menu">
							<a href="https://adomantra.com/about" target="_blank" class="kt-footer__menu-link kt-link">About</a>
							<a href="https://adomantra.com/platform" target="_blank" class="kt-footer__menu-link kt-link">Team</a>
							<a href="https://adomantra.com/contact-us" target="_blank" class="kt-footer__menu-link kt-link">Contact</a>
						</div>
					</div>
