...
if (isset($_POST['submit'])) {
	...
	$insertQuery = "INSERT INTO device (deviceType,status) VALUES ('".$DeviceName."',1)";
	$query = mysqli_query($con,$insertQuery) or die(mysqli_error($con));
	if ($query) {
		header("Location: add_addType.php");
	}
}
?>
<!DOCTYPE html>
										...
										<form class="kt-form" method="post">
											<div class="kt-portlet__body">
												...
												<div class="form-group">
													<input name="deviceName" id="deviceName" type="text" class="form-control" aria-describedby="emailHelp" placeholder="Enter Device Name">
													<span class="form-text text-muted">Add new device which is not added in the list.</span>
												</div>
<div class="kt-portlet__head">
<div class="kt-form__actions">
	<input name="submit" type="submit" class="btn btn-primary" id="addDevice" value="Add">
	<a href="add_addType.php">
	<input name="button" type="button" class="btn btn-success" value="Add AdType">
	</a>
</div>
</div>
...
<form class="kt-form">
	<div class="kt-portlet__body">
    	...
    	while ( $row=mysqli_fetch_assoc($querydevice)) {
			...
			<input type='email' class='form-control' disabled='disabled' placeholder='".$row['deviceType']."'>
		</div>";
